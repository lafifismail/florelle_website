            ...
            <main className="flex-grow pt-24 pb-24 px-4 md:px-12">
                <div className="max-w-4xl mx-auto">
                    <header className="mb-8">
                        <Link href="/profile" className="inline-flex items-center text-xs text-charcoal/60 hover:text-gold mb-4 transition-colors">
                            <ArrowLeft size={14} className="mr-1" /> Retour au profil
                        </Link>
                        <h1 className="font-serif text-3xl md:text-4xl text-charcoal">Mes Commandes</h1>
                        <p className="text-charcoal/60 text-sm mt-2">Historique complet de vos achats</p>
                    </header>

                    <div className="bg-white p-6 md:p-8 shadow-sm border border-beige/20 rounded-sm min-h-[400px]">
                        {user.orders.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {user.orders.map((order) => (
                                    <div key={order.id} className="flex flex-col md:flex-row md:items-center justify-between p-6 border border-beige/10 rounded hover:border-gold/30 transition-all group bg-off-white/30 hover:bg-white hover:shadow-luxury-hover">
